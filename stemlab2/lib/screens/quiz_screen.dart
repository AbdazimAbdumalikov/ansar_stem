...
import 'package:stemlab2/common/extensions.dart';
import 'package:stemlab2/common/theme_helper.dart';
import 'package:stemlab2/models/dto/option_selection.dart';
import 'package:stemlab2/models/dto/quiz_result.dart';
import 'package:stemlab2/models/option.dart';
import 'package:stemlab2/models/question.dart';
...
import 'package:stemlab2/services/quiz_engine.dart';
import 'package:stemlab2/stores/quiz_store.dart';
import 'package:stemlab2/widgets/disco_button.dart';
import 'package:stemlab2/widgets/question_option.dart';
import 'package:stemlab2/widgets/time_indicator.dart';
    ...
    store.getCategoryAsync(quiz.categoryId).then((category) {
      store
          .saveQuizHistory(QuizHistory(quiz.id, quiz.title, category.id,
              "$total/${quiz.questions.length}", takenTime.format(), DateTime.now(), "Аяқталды"))
          .then((value) {
